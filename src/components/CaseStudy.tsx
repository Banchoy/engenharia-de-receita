...
export default function CaseStudy() {
    return (
        <section id="case-study" className="w-full py-32 px-6 flex flex-col items-center">
            <div className="w-full max-w-5xl glass rounded-[4rem] border-neon/10 overflow-hidden flex flex-col md:flex-row items-stretch min-h-[700px] shadow-[0_50px_100px_rgba(0,0,0,0.5)]">
                <div className="p-10 md:p-24 md:w-3/5 space-y-14 flex flex-col justify-center items-center text-center relative z-10">
                    ...
                    <div className="flex flex-wrap justify-center gap-10 md:gap-16 pt-4 w-full">
                        <div className="space-y-1">
                            <p className="text-4xl md:text-5xl font-heading font-black text-neon neon-text font-outline-1 tracking-tighter">427%</p>
                ...
                <div className="md:w-2/5 relative min-h-[500px] md:min-h-full bg-zinc-950/40 border-l border-white/5 flex items-center justify-center overflow-hidden">
                    <img
                        src="/iceberg.png"
                        alt="Análise Profunda de Receita"
                        className="absolute inset-0 w-full h-full object-cover opacity-40 brightness-110 contrast-125 scale-110"
                    />
                    ...
                    <div className="absolute inset-0 z-20 pointer-events-none flex flex-col justify-between p-12">
                        ...
                        <div className="text-center space-y-4 w-full">
                            <div className="space-y-0">
                                <span className="text-white font-black text-[70px] md:text-[100px] leading-none tracking-tighter block font-outline-1 opacity-10">399X</span>
                                <span className="text-neon neon-text font-black text-[10px] uppercase tracking-[0.5em] block -mt-4">Potencial Oculto</span>
                            </div>
                            <div className="pt-4 border-t border-white/5 max-w-[200px] mx-auto opacity-40">
