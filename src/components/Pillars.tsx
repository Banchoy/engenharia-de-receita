...
export default function Pillars() {
    return (
        <section id="pillars" className="w-full py-16 md:py-32 px-6 bg-background relative overflow-hidden flex flex-col items-center">
            ...
            <div className="w-full max-w-6xl relative z-10 flex flex-col items-center">
                <div className="text-center mb-20 md:mb-32 space-y-6 w-full flex flex-col items-center">
                    <h2 className="text-4xl md:text-7xl font-heading font-black leading-none text-white uppercase tracking-tighter text-balance">
                        A CIÊNCIA DA <br /><span className="text-neon neon-text text-balance">ENGENHARIA</span>
                    </h2>
                ...
                <div className="w-full max-w-4xl mx-auto mb-20 md:mb-32">
                    <div className="flex flex-col items-center gap-10 p-8 md:p-20 rounded-[4rem] glass border-neon/10 text-center shadow-premium relative group overflow-hidden">
                        <div className="absolute inset-0 bg-neon/5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                        <h4 className="text-3xl md:text-5xl font-heading font-black max-w-md mx-auto leading-tight text-white uppercase tracking-tighter relative z-10 text-balance">
...
function PillarCard({ pillar, index }: { pillar: any; index: number }) {
    ...
    return (
        <motion.div
            ...
            className="group relative p-8 md:p-12 rounded-[3.5rem] border border-white/5 bg-zinc-950/40 hover:border-neon/30 transition-all duration-700 shadow-2xl hover:shadow-neon/10 flex flex-col items-center text-center h-auto w-full"
        >
            ...
            <h3 className="text-2xl font-heading font-black mb-8 text-white uppercase tracking-tighter leading-tight shrink-0 text-balance">
                {pillar.title}
            </h3>
            ...
            <div className="flex-1 flex flex-col items-center w-full">
                ...
                <AnimatePresence>
                    {isOpen && (
                        ...
                        >
                            <p className="text-[#E5E7EB]/70 text-sm md:text-base leading-relaxed font-medium pt-8 border-t border-neon/10 break-words w-full">
                                {pillar.description}
                            </p>
                        </motion.div>
                    )}
