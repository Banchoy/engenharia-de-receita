        ...
        <section id="anatomy" className="w-full py-32 px-6 flex flex-col items-center bg-zinc-950/20">
            <div className="w-full max-w-6xl relative z-10">
                <div className="text-center mb-24 space-y-6">
                    <h2 className="text-4xl md:text-7xl font-heading font-black text-white tracking-tighter uppercase leading-none">
                ...
                <div className="grid lg:grid-cols-2 gap-10 md:gap-16">
                    ...
                    <div className="relative flex flex-col h-full">
                        <div className="flex-1 bg-zinc-950/40 border border-white/5 p-10 md:p-14 rounded-[3.5rem] flex flex-col space-y-10 group hover:border-red-500/20 transition-all duration-500 min-h-[500px] h-auto">
                            <div className="flex items-center gap-4 text-red-500">
                                <ShieldAlert className="w-8 h-8 shrink-0" />
                                <span className="text-xs font-black uppercase tracking-[0.3em]">Agência Comum</span>
                            </div>

                            <h3 className="text-2xl md:text-3xl font-heading font-black text-white uppercase tracking-tight leading-tight">
                            ...
                            <div className="flex-1 space-y-8">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-2 opacity-50">
                                    ...
                                    <p className="text-white font-medium text-lg italic leading-[1.6]">"Aumente suas vendas hoje mesmo!"</p>
                                </div>
                                <ul className="space-y-6">
                                    {[
                                        ...
                                        <li key={i} className="flex items-start gap-4 text-[#E5E7EB]/60 text-sm md:text-base font-medium leading-[1.6]">
                    ...
                    <div className="relative flex flex-col h-full">
                        <div className="flex-1 bg-zinc-950/60 border border-neon/20 p-10 md:p-14 rounded-[3.5rem] flex flex-col space-y-10 shadow-[0_0_50px_rgba(222,255,154,0.05)] hover:border-neon group transition-all duration-500 min-h-[500px] h-auto">
                            ...
                            <div className="flex-1 space-y-8">
                                <div className="p-6 rounded-2xl bg-neon/5 border border-neon/20 space-y-2 shadow-inner">
                                    ...
                                    <p className="text-white font-black text-lg leading-[1.6]">"Exclusivo para operações que faturam +R$ 100k/mês"</p>
                                </div>
                                <ul className="space-y-6">
                                    {[
                                        ...
                                        <li key={i} className="flex items-start gap-4 text-[#E5E7EB] text-sm md:text-base font-medium leading-[1.6]">
                                            <CheckCircle2 className="w-5 h-5 text-neon shrink-0 mt-1" />
                                            <span className="flex-1">{item}</span>
                                        </li>
                                    ))}
                                </ul>
